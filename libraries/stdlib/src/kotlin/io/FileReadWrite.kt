 ...
 */
public fun File.forEachBlock(action: (buffer: ByteArray, size: Int) -> Unit): Unit = forEachBlock(DEFAULT_BLOCK_SIZE, action)
 ...
 */
public fun File.forEachBlock(blockSize: Int, action: (buffer: ByteArray, size: Int) -> Unit): Unit {
