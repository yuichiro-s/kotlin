...
internal fun genPropertyForWidget(
    ...
    val sourceEl = resolvedWidget.widget.sourceElement?.let(::XmlSourceElement) ?: org.jetbrains.kotlin.descriptors.SourceElement.NO_SOURCE
...
internal fun genPropertyForFragment(
    ...
    val sourceElement = fragment.sourceElement?.let(::XmlSourceElement) ?: org.jetbrains.kotlin.descriptors.SourceElement.NO_SOURCE
