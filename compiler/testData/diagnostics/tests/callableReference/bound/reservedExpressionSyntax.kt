...
class Test {
    ...
    fun <T> List<T>.<!SPECIFY_TYPE_EXPLICITLY!>testClassLiteral2<!>() = <!RESERVED_SYNTAX_IN_CALLABLE_REFERENCE_LHS!>b<!>?::class
    fun <T> List<T>.<!SPECIFY_TYPE_EXPLICITLY!>testClassLiteral3<!>() = <!RESERVED_SYNTAX_IN_CALLABLE_REFERENCE_LHS!>b<T, Any><!>::class
