...
public open external class Promise<T>(executor: (resolve: (T) -> Unit, reject: (Throwable) -> Unit) -> Unit) {
    companion object {
        public fun <S> all(vararg promise: Promise<out S>): Promise<Array<in S>>

        public fun <S> race(vararg promise: Promise<out S>): Promise<S>
