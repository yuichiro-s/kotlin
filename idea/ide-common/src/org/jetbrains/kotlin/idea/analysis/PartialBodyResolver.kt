...
class PartialBodyResolver(
        private val resolveSession: ResolveSession,
        private val codeFragmentAnalyzer: CodeFragmentAnalyzer,
        private val targetPlatform: TargetPlatform,
        private val probablyNothingCallableNames: () -> ProbablyNothingCallableNames
) {
    ...
    fun constructorAdditionalResolve(resolveSession: ResolveSession, klass: KtClass, file: KtFile, filter : BindingTraceFilter): BindingTrace {
